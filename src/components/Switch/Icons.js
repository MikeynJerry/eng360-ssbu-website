...
export const RightJoyconIcon = ({ override, color = 'gray' }) => (
    ...
    <svg
      ...
      <g id="Capa_x0020_1">
        <g id="_2497485212656">
          ...
          />
          <circle className="fil8 str0" cx="23673" cy="2074" r="392" />
          <circle className="fil8 str0" cx="24552" cy="2884" r="392" />
          <circle className="fil8 str0" cx="23678" cy="3704" r="392" />
          <circle className="fil8 str0" cx="22842" cy="2889" r="392" />
