...
export const Switch = ({ classes, leftJoyconColor, rightJoyconColor }) => (
  <div className={classes.root}>
    <Sticky enabled top={100}>
      <LeftJoyconIcon color={leftJoyconColor} />
    </Sticky>
    <Sticky enabled top={100}>
      <RightJoyconIcon color={rightJoyconColor} />
    </Sticky>
    <SwitchIcon />
    <p>
...
Switch.propTypes = {
  ...
  switch: PropTypes.object // from enhancer (firestoreConnect + connect)
}
